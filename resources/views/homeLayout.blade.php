...
<head>
    ...
    <title>Home | E-Commerce Source</title>
    <link href="{{asset('fend/css/bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{asset('fend/css/font-awesome.min.css')}}" rel="stylesheet">
    <link href="{{asset('fend/css/prettyPhoto.css')}}" rel="stylesheet">
    <link href="{{asset('fend/css/price-range.css')}}" rel="stylesheet">
    <link href="{{asset('fend/css/animate.css')}}" rel="stylesheet">
    <link href="{{asset('fend/css/main.css')}}" rel="stylesheet">
    <link href="{{asset('fend/css/responsive.css')}}" rel="stylesheet">
    <!--[if lt IE 9]>
    <script src="{{asset('fend/js/html5shiv.js')}}"></script>
    <script src="{{asset('fend/js/respond.min.js')}}"></script>
    <![endif]-->
    <link rel="shortcut icon" href="{{asset('fend/images/ico/favicon.ico')}}">
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{asset
                ...
                <div class="col-sm-6">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            <li><a href="#"><i class="fa fa-phone"></i> +880 17 873 50 229</a></li>
                            <li><a href="#"><i class="fa fa-envelope"></i> info@ecomshop.com</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="logo pull-left">
                        <a href="{{URL::to('/')}}"><img src="{{asset('fend/images/home/logo.png')}}" alt="" /></a>
                    </div>
...
<script src="{{asset('fend/js/bootstrap.min.js')}}"></script>
<script src="{{asset('js/jquery.scrollUp.min.js')}}"></script>
<script src="{{asset('fend/js/price-range.js')}}"></script>
